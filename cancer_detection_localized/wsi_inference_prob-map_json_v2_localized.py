...
class extractPatch:
    ...
    def __init__(self):
        self.save_location = '/path/to/output' # cur_wd + '/data/cancer_output100and2/'
        self.mag_extract = [10] # do not change this, model trained at 250x250 at 20x
        self.save_image_size = 500  # do not change this, model trained at 250x250 at 20x
        self.run_image_size = 500 # do not change this, model trained at 250x250 at 20x
        ...
        self.tiff_lvl = 4 # low res pyramid level to grab
        self.model_path2 = '/path/to/models/binary_mblntv3_25ep_lr1e5_wAug_MixUpLS_sz500_bs12_10x.pkl' #cur_wd + '/code_s/cancer_detection/dlv3_2ep_2e4_update-07182023_RT.pkl'
    ...
    def parseMeta_and_pullTiles(self,flist):
        ...
        learn = load_learner(self.model_path2,cpu=False) 
...
if __name__ == '__main__':
    ...
    prossessed_flist=sorted(glob.glob(cur_wd + '/data/cancer_output100and2/*png'))
    prossessed_flist = [re.sub(cur_wd + '/data/cancer_output100and2/', "", x) for x in prossessed_flist]
