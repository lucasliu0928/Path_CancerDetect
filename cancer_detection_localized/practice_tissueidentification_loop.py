...
save_location = cur_wd + 'intermediate_data/cancer_prediction_results0710/'  # args.save_location
save_location2 = cur_wd + 'intermediate_data/cancer_prediction_results0710/tiles/'  # args.save_location
save_location3 = cur_wd + 'intermediate_data/cancer_prediction_results0710/cancer_pred_out/'  # args.save_location
...
save_location3 = save_location3 + str(pixel_overlap) + 'and' + str(tiff_lvl)  # args.save_location
...
if not os.path.exists(save_location2):
    os.mkdir(save_location2)
if not os.path.exists(save_location3):
    os.mkdir(save_location3)
...
selected_ids = ['OPX_185','OPX_194','OPX_053','OPX_160','OPX_186']
