...
#run: python3 -u 7_train_ACMIL.py --train_cohort TCGA_PRAD --external_cohort1 Neptune --external_cohort2 OPX --s_fold 0 --hr_type HR2 --f_alpha 0.7 --f_gamma 0
#python3 -u 7_train_ACMIL.py --train_cohort OPX --external_cohort1 Neptune --external_cohort2 TCGA_PRAD --s_fold 1 --hr_type HR2
