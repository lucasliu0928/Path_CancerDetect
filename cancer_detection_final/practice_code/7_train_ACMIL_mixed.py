...
#Run: python3 -u 7_train_ACMIL_mixed.py --GRL True --mutation MT --train_cohort OPX_TCGA
############################################################################################################
#Parser
############################################################################################################
...
parser.add_argument('--out_folder', default= 'pred_out_061825', type=str, help='out folder name')
...
if __name__ == '__main__':
    ...
    for f in fold_list:
        ...
        if args.use_sep_cri:
            ...
            ext_loader_st0   = DataLoader(dataset=ext_data_nep_st0,  batch_size=args.BATCH_SIZE, shuffle=False)
            ext_loader_st1   = DataLoader(dataset=ext_data_nep_st1,  batch_size=args.BATCH_SIZE, shuffle=False)             
