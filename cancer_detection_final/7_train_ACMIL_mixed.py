...
#Run: python3 -u 7_train_ACMIL_mixed.py --GRL False
############################################################################################################
#Parser
############################################################################################################
...
if __name__ == '__main__':
    ...
    if args.use_sep_cri:
        ...
        all_perd_df.to_csv(outdir44 + "/n_token" + str(conf.n_token) + "_OPX_pred_df2.csv",index = False)
        all_perf_df.to_csv(outdir55 + "/n_token" + str(conf.n_token) + "_OPX_perf2.csv",index = True)
        ...
        print(ci_final_df)
        ci_final_df.to_csv(outdir55 + "/n_token" + str(conf.n_token) + "_OPX_perf_bootstrap2.csv",index = True)
        ...
        all_perd_df.to_csv(outdir44 + "/n_token" + str(conf.n_token) + "_TCGA_pred_df2.csv",index = False)
        all_perf_df.to_csv(outdir55 + "/n_token" + str(conf.n_token) + "_TCGA_perf2.csv",index = True)
        print(round(all_perf_df['AUC'].mean(),2))
        ...
        ci_final_df = pd.concat(ci_list)
        print(ci_final_df)
        ci_final_df.to_csv(outdir55 + "/n_token" + str(conf.n_token) + "_TCGA_perf_bootstrap2.csv",index = True)
        ...
        all_perd_df.to_csv(outdir44 + "/n_token" + str(conf.n_token) + "_TEST_COMB_pred_df2.csv",index = False)
        all_perf_df.to_csv(outdir55 + "/n_token" + str(conf.n_token) + "_TEST_COMB_perf2.csv",index = True)
        print(round(all_perf_df['AUC'].mean(),2))
        ...
        ci_final_df = pd.concat(ci_list)
        print(ci_final_df)
        ci_final_df.to_csv(outdir55 + "/n_token" + str(conf.n_token) + "_TEST_COMB_perf_bootstrap2.csv",index = True)
        ...
        all_perd_df.to_csv(outdir44 + "/n_token" + str(conf.n_token) + "_EXT_pred_df2.csv",index = False)
        all_perf_df.to_csv(outdir55 + "/n_token" + str(conf.n_token) + "_EXT_perf2.csv",index = True)
        print(round(all_perf_df['AUC'].mean(),2))
        ...
        ci_final_df = pd.concat(ci_list)
        print(ci_final_df)
        ci_final_df.to_csv(outdir55 + "/n_token" + str(conf.n_token) + "_EXT_perf_bootstrap2.csv",index = True)
