...
class extractPatch:
    ...
    def __init__(self):
        self.save_location = '/path/to/save'  # args.save_location
        ...
        self.smooth = True # whether or not to gaussian smooth the output probability map
        self.model_path2 = '/path/to/dlv3_2ep_2e4_update-07182023_RT.pkl'
...
if __name__ == '__main__':
    ...
    # print(args)
    #df = pd.read_csv('/data/MIP/harmon-lab/mpca/codes/cancer_detection/inference/wcdt_inf_clindat.csv')
    #flist = df.values.tolist()
    flist=sorted(glob.glob('/example/path/to/images/*.svs'))
    c = extractPatch()
