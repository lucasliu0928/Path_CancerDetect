...
class extractPatch:
    ...
    def __init__(self):
        self.save_location = '/data/MIP/harmon-lab/mpca/WSI/TAN_WSI/cancer_output'  # args.save_location
        ...
        self.model_path2 = '/data/MIP/harmonsa/pca_fhcrc/tumor_seg/training_log/exported_models/dlv3_2ep_2e4_update-07182023_RT.pkl'
...
if __name__ == '__main__':
    ...
    # print(args)
    flist=sorted(glob.glob('/data/MIP/harmon-lab/mpca/WSI/TAN_WSI/*.tif'))
    c = extractPatch()
