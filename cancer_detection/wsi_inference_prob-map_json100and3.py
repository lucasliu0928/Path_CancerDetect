...
class extractPatch:
    ...
    def __init__(self):
        self.save_location = cur_wd + '/data/cancer_output100and3/'  # args.save_location
...
if __name__ == '__main__':
    ...
    prossessed_flist=sorted(glob.glob(cur_wd + '/data/cancer_output100and3/*png'))
    prossessed_flist = [re.sub(cur_wd + '/data/cancer_output100and3/', "", x) for x in prossessed_flist]
